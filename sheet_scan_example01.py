...
# 寻找轮廓
# 这里如果openCV版本较新可能会抛出异常。findContours方法在新版本中返回两个结果。而旧版本为3个结果
# 可以考虑更换版本为 pip install opencv-python==3.4.3.18 降低版本后即可正常运行
...
# 按面积大小对所有的轮廓排序
data_list = sorted(cts, key=cv.contourArea, reverse=True)
